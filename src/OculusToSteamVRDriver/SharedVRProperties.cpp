...
{
	//vr::VRProperties()->SetUint64Property(properties, vr::Prop_CurrentUniverseId_Uint64, 31); //Lighthouse.
	vr::VRProperties()->SetUint64Property(properties, vr::Prop_CurrentUniverseId_Uint64, 1); //Oculus.
	//vr::VRProperties()->SetStringProperty(properties, vr::Prop_TrackingSystemName_String, "lighthouse");
	vr::VRProperties()->SetStringProperty(properties, vr::Prop_TrackingSystemName_String, "oculus");
