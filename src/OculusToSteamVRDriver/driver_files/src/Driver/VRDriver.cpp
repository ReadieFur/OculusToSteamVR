...
vr::EVRInitError OculusToSteamVRDriver::VRDriver::Init(vr::IVRDriverContext* pDriverContext)
{
...
void OculusToSteamVRDriver::VRDriver::Cleanup()
{
}

void OculusToSteamVRDriver::VRDriver::RunFrame()
{
    // Collect events
    vr::VREvent_t event;
...
bool OculusToSteamVRDriver::VRDriver::ShouldBlockStandbyMode()
{
    return false;
}

void OculusToSteamVRDriver::VRDriver::EnterStandby()
{
}

void OculusToSteamVRDriver::VRDriver::LeaveStandby()
{
}

std::vector<std::shared_ptr<OculusToSteamVRDriver::IVRDevice>> OculusToSteamVRDriver::VRDriver::GetDevices()
{
    return this->devices_;
}

std::vector<vr::VREvent_t> OculusToSteamVRDriver::VRDriver::GetOpenVREvents()
{
    return this->openvr_events_;
}

std::chrono::milliseconds OculusToSteamVRDriver::VRDriver::GetLastFrameTime()
{
    return this->frame_timing_;
}

bool OculusToSteamVRDriver::VRDriver::AddDevice(std::shared_ptr<IVRDevice> device)
{
...
OculusToSteamVRDriver::SettingsValue OculusToSteamVRDriver::VRDriver::GetSettingsValue(std::string key)
{
...
void OculusToSteamVRDriver::VRDriver::Log(std::string message)
{
    std::string message_endl = message + "\n";
    vr::VRDriverLog()->Log(message_endl.c_str());
}

vr::IVRDriverInput* OculusToSteamVRDriver::VRDriver::GetInput()
{
    return vr::VRDriverInput();
}

vr::CVRPropertyHelpers* OculusToSteamVRDriver::VRDriver::GetProperties()
{
    return vr::VRProperties();
}

vr::IVRServerDriverHost* OculusToSteamVRDriver::VRDriver::GetDriverHost()
{
