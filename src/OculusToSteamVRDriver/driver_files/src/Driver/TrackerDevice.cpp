...
OculusToSteamVRDriver::TrackerDevice::TrackerDevice(std::string serial):
    serial_(serial)
{
}

std::string OculusToSteamVRDriver::TrackerDevice::GetSerial()
{
    return this->serial_;
}

void OculusToSteamVRDriver::TrackerDevice::Update()
{
...
DeviceType OculusToSteamVRDriver::TrackerDevice::GetDeviceType()
{
    return DeviceType::TRACKER;
}

vr::TrackedDeviceIndex_t OculusToSteamVRDriver::TrackerDevice::GetDeviceIndex()
{
    return this->device_index_;
}

vr::EVRInitError OculusToSteamVRDriver::TrackerDevice::Activate(uint32_t unObjectId)
{
...
void OculusToSteamVRDriver::TrackerDevice::Deactivate()
{
    this->device_index_ = vr::k_unTrackedDeviceIndexInvalid;
}

void OculusToSteamVRDriver::TrackerDevice::EnterStandby()
{
}

void* OculusToSteamVRDriver::TrackerDevice::GetComponent(const char* pchComponentNameAndVersion)
{
    return nullptr;
}

void OculusToSteamVRDriver::TrackerDevice::DebugRequest(const char* pchRequest, char* pchResponseBuffer, uint32_t unResponseBufferSize)
{
    if (unResponseBufferSize >= 1)
        pchResponseBuffer[0] = 0;
}

vr::DriverPose_t OculusToSteamVRDriver::TrackerDevice::GetPose()
{
    return last_pose_;
}
